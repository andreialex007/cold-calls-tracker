...
{
    public partial class QuoteTemplateCostingTemplate2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuoteTemplateCostingTemplate", x => new { x.QuoteTemplateId, x.CostingTemplateId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuoteTemplateCostingTemplate_CostingTemplateId",
                table: "QuoteTemplateCostingTemplate",
                column: "CostingTemplateId");
        }
